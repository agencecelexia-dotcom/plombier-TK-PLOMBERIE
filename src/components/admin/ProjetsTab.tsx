            ...
            <div className="space-y-4 px-6 py-5">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input type="text" value={form.location} onChange={(e) => setForm((f) => ({ ...f, location: e.target.value }))} className="w-full rounded-lg border border-neutral-200 px-3 py-2.5 text-sm focus:border-primary-900 focus:outline-none" placeholder="Livry-Gargan" />
                </div>
                <div>
